...
public class FavoritePlaceReviewController {
  ...
  /**
   * 공연장 상세 페이지 - 리뷰 섹션에서 호출.
   * 특정 공연장 리뷰를 사용자가 관심하고 있는지 여부를 반환.
   *
   * @param userId
   * @param placeReviewId
   * @return
  ...
  /**
   * 공연장 상세 페이지 - 리뷰 섹션에서 호출. (하트 표시 용도)
   * 사용자가 좋아요한 공연장 리뷰 ID를 반환.
   *
   * @param userId
   * @return
   */
